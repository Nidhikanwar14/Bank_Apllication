...
public class Main {
    public static void main(String[] args) throws InsufficientAmount {
        ICICI Owner_1 = new ICICI("Nidhi_kanwar", BigDecimal.valueOf(1000),AccountType.SAVING);
        HDFC Owner_2 = new HDFC("Ragini_patel", BigDecimal.valueOf(15000),AccountType.CURRENT);
