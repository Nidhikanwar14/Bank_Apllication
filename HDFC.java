...
public class HDFC extends Account implements BankAccount {
    public HDFC(String owner, BigDecimal balance ,AccountType acc , BigDecimal minAmount) throws InsufficientAmount {
...
//        System.out.println("Deposited " +amount+ " and total balance is "+this.getBalance()+".");
    ...
    public void withdraw(BigDecimal amount) throws InsufficientAmount{
        ...
        System.out.println(this.getOwner()+" Withdraw " +amount+ " from total balance and remaining amount is "+this.getBalance()+".");
    }

    @Override
    public void setOverdraft(BigDecimal amount) {
        super.setOverdraft(amount);
    }
